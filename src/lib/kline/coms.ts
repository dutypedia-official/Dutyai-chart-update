...
export const IndFieldsMap: Record<string, Record<string, unknown>[]> = {
  ...
  EMA: [
    { title: 'Period', precision: 0, min: 1, default: 20 },
  ...
  TRAP_HUNTER: [
    { title: 'Resistance Lookback', precision: 0, min: 1, default: 20 },
    { title: 'Support Lookback', precision: 0, min: 1, default: 20 },
    { title: 'Confirmation Bars', precision: 0, min: 1, default: 4 },
    { title: 'Max Trap Bars', precision: 0, min: 1, default: 6 },
    { title: 'Volume MA Period', precision: 0, min: 1, default: 20 },
    { title: 'Min Volume Spike', precision: 2, min: 0.1, default: 1.2 },
    { title: 'Min Breakout Factor', precision: 4, min: 0.0000, default: 0.0005 },
    { title: 'Min Wick Ratio', precision: 2, min: 0.0, max: 1.0, default: 0.35 },
    { title: 'Min Trap Score', precision: 2, min: 0.0, max: 1.0, default: 0.5 },
    { title: 'Enable Normal Signal (0/1)', precision: 0, min: 0, max: 1, default: 1 },
    { title: 'Normal Quiet Bars', precision: 0, min: 1, default: 5 }
  ],
  SMART_MONEY: [
    { title: 'Zone Lookback Bars', precision: 0, min: 10, default: 40 },
    { title: 'Min Zone Bars', precision: 0, min: 3, default: 5 },
    { title: 'Max Zone Bars', precision: 0, min: 5, default: 25 },
    { title: 'ATR Period', precision: 0, min: 1, default: 14 },
    { title: 'Volume MA Period', precision: 0, min: 1, default: 20 },
    { title: 'Min Volume Factor', precision: 2, min: 0.1, default: 1.2 },
    { title: 'Max Zone Width %', precision: 3, min: 0.001, default: 0.03 },
    { title: 'Prior Trend Lookback', precision: 0, min: 1, default: 20 },
    { title: 'Min OBV Trend Strength', precision: 2, min: 0.0, default: 0.2 },
    { title: 'Min Zone Score', precision: 2, min: 0.0, max: 1.0, default: 0.6 },
    { title: 'Merge Nearby Zones (0/1)', precision: 0, min: 0, max: 1, default: 1 },
    { title: 'Max Zones Displayed', precision: 0, min: 1, default: 20 },
    { title: 'Show Labels (0/1)', precision: 0, min: 0, max: 1, default: 1 }
  ],
  VOLCANIC: [
    { title: 'BB Period', precision: 0, min: 1, default: 16 },
    { title: 'BB StdDev', precision: 2, min: 0.1, default: 2.0 },
    { title: 'ATR Period', precision: 0, min: 1, default: 14 },
    { title: 'Volume MA Period', precision: 0, min: 1, default: 20 },
    { title: 'Normalize Lookback', precision: 0, min: 10, default: 60 },
    { title: 'Pressure SMA', precision: 0, min: 1, default: 2 },
    { title: 'Min Pressure Alert', precision: 2, min: 0.0, max: 1.0, default: 0.55 },
    { title: 'Confirm Bars', precision: 0, min: 1, default: 1 },
    { title: 'Min Volume x', precision: 2, min: 0.5, default: 1.0 },
    { title: 'Min Range x', precision: 2, min: 0.5, default: 1.0 },
    { title: 'Min Body % of Range', precision: 2, min: 0.0, max: 1.0, default: 0.5 },
    { title: 'Breakout Lookback', precision: 0, min: 5, default: 10 },
    { title: 'Min Bars Between Signals', precision: 0, min: 1, default: 1 },
    { title: 'Trend EMA Period', precision: 0, min: 2, default: 30 },
    { title: 'Require Trend Align (0/1)', precision: 0, min: 0, max: 1, default: 0 },
    { title: 'Breakout Buffer %', precision: 4, min: 0.0000, default: 0.0007 },
    { title: 'Require BB Band Break (0/1)', precision: 0, min: 0, max: 1, default: 0 },
    { title: 'Retest Window (bars)', precision: 0, min: 1, default: 1 }
  ],
  VOLCANIC_SIG: [
    { title: 'BB Period', precision: 0, min: 1, default: 16 },
    { title: 'BB StdDev', precision: 2, min: 0.1, default: 2.0 },

 ...
 * @param drawArgs
 */
export function drawCloudInd (drawArgs: IndicatorDrawParams<any, any, any>) {
 ...
 * 绘制缠论的线条
 */
export function drawChanlun({ctx, indicator, chart, xAxis, yAxis}: IndicatorDrawParams<any, any, any>): boolean {
  // 指标计算结果
 ...
 * @param yAxis
 */
export function drawFigures({ctx, chart, indicator, xAxis, yAxis}: IndicatorDrawParams<any, any, any>){

  ...
  createPointFigures: ({ chart, coordinates, overlay, yAxis }) => {
    ...
    if (coordinates.length > 1) {
      ...
      const expandedCoords = [
        { x: pt1.x - hitAreaPadding, y: pt1.y - hitAreaPadding },
        { x: pt2.x + hitAreaPadding, y: pt1.y - hitAreaPadding },
        { x: pt2.x + hitAreaPadding, y: pt2.y + hitAreaPadding },
        { x: pt1.x - hitAreaPadding, y: pt2.y + hitAreaPadding }
      ]
      ...
      figures.push(...vertArrow)
      figures.push(...horzArrow)
